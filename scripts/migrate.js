...
class MigrationRunner {
  ...
  async migrate() {
    ...
    console.log('🎉 All auth service migrations completed successfully!');
  }

  async rollback(version = null) {
    console.log('🔄 Rolling back auth service migrations...');
  ...
  async status() {
    console.log('📊 Auth Service Migration Status:');
    console.log('==================================');
